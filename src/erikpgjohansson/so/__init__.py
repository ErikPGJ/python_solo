# -*- coding: UTF-8 -*-
'''
NOTE: Uncertain whether this is a legitimate location for
functions erikpgjohansson.so.*.
...
def parse_dataset_filename(filename):
    ...
    NOTE: Can amend code o return more filename fields eventually.
    ...
    def add_test(filename, expResult):
        tl.append(
            erikpgjohansson.atest.FunctionCallTest(
                erikpgjohansson.so.parse_dataset_filename, (filename,), expResult=expResult))
    def add_test_exc(args):
        tl.append(
            erikpgjohansson.atest.FunctionCallTest(
                erikpgjohansson.so.parse_dataset_filename, args, expExcType=Exception))
...
def parse_DATASET_ID___ATEST():
    ...
    def add_test(args, expResult):
        tl.append(
            erikpgjohansson.atest.FunctionCallTest(
                erikpgjohansson.so.parse_DATASET_ID, args, expResult=expResult))
    def add_test_exc(args):
        tl.append(
            erikpgjohansson.atest.FunctionCallTest(
                erikpgjohansson.so.parse_DATASET_ID, args, expExcType=Exception))
